...
<jsp:include page="../top_navbar.jsp"></jsp:include>
	   <div class="container" style="padding-top:50px">
			<h1 style="text-align: left;">리뷰등록</h1>
	      <div class="col" style="display: inline-block;">
	         <img id="gymImg" src="../../resources/image_gym/${gymInfo.img}" style="width:400px;height: 250px;"/>
	      </div>
	      ...
	      <div>
			<label>공간은 어떠셨나요?</label>
			<br>
	      	<form class="mb-3" name="myform" id="myform" action="/review/reviewInsert" method="POST" onsubmit="return frmSub()">
				<input type="hidden" name="resv_id" value="${resv_id}">
				<input type="hidden" name="gym_id" value="${gymInfo.id}">
				<fieldset>
				...
				<div>
					<textarea class="col-auto form-control" id="reviewContents"
							  placeholder="이용후기를 남겨주세요." name="content"></textarea>
				</div>
			      <div class="btn_div">
